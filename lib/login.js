import puppeteer from 'puppeteer'; // Removed Browser, Page type imports

// LoginResult interface removed

export async function loginToApp() { // Removed Promise<LoginResult>
  ...
  let browser = null; // Removed : Browser | null type annotation
  try {
    ...
    const page = await browser.newPage(); // No type annotation needed for page
